...
|impact (optional)|Impact of the change on the service level of the affected business processes.<br><br>The following are the supported values:<br>- 1: Extensive/Widespread<br>- 2: Significant/Large<br>- 3: Moderate/Limited<br>- (Default) 4: Minor/Localized|integer|
urgency (optional)|Urgency measures how soon the change will significantly impact the business.<br><br>For example, a high-impact change may have low urgency if the impact is not expected to affect the business in the near future.<br><br>The following are the supported values:<br>- 1: Critical<br>- 2: High<br>- 3: Medium<br>- (Default) 4: Low|integer|
